...
const removeAnswer = () => {
  if (confirm("Are you sure?")) {
    router.delete(route('questions.answers.destroy', [props.answer.question_id, props.answer.id]), {
      preserveScroll: true
    })
  }
}
  ...
  <div class="post-item my-4 border-bottom">
    <div class="vote-col">
      <div class="d-flex flex-column align-items-center">
        ...
        <button title="Mark the answer ans accepted" :disable="!answer.can_be.accepted" @click="acceptAnswer"
    ...
    <div class="post-col actionable">
      ...
      <ActionButton :allow-updated="answer.can_be.updated" :allow-deleted="answer.can_be.deleted" @remove="removeAnswer"
